...
- **Parsing positionnel fragile** : si l'ordre des questions du Google Form change l'an prochain, l'import décale silencieusement les colonnes. Solution proposée par Claude : lire les colonnes par mot-clé dans l'en-tête plutôt que par position — chantier réel sur le code d'import, PAS ENCORE LANCÉ, en attente d'un "go" explicite de Valentin.
